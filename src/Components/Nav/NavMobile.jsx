    ...
    <NavDiv position={props.position} background={props.background}>
      <Logo className="logo rainbow" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 833.25 392.83">
        <g className="sunrise_x5F_layer">
          ...
          <g id="letter">
          <path className="st1" style={{fill: "#a2d4ff"}}
      ...
      <NavMobileDiv onClick={isOpen === 'none' ? () => setOpen('block') : () => setOpen('none')}>
        <NavMobileLogo className="rainbow" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 64 64">
            {isOpen === 'none' ? 
            <path d="M58.65,61H5.35C2.4,61,0,58.6,0,55.65v0c0-2.96,2.4-5.35,5.35-5.35h53.29c2.96,0,5.35,2.4,5.35,5.35v0C64,58.6,61.6,61,58.65,61z"/> : 
            ...
            {isOpen === 'none' ? <path d="M58.65,37.35H5.35C2.4,37.35,0,34.96,0,32v0c0-2.96,2.4-5.35,5.35-5.35h53.29c2.96,0,5.35,2.4,5.35,5.35v0C64,34.96,61.6,37.35,58.65,37.35z"/> : null}
            {isOpen === 'none' ? 
            <path d="M58.65,13.71H5.35C2.4,13.71,0,11.31,0,8.35v0C0,5.4,2.4,3,5.35,3h53.29C61.6,3,64,5.4,64,8.35v0C64,11.31,61.6,13.71,58.65,13.71z"/> :
        ...
        <NavMobileMenuUl>
          ...
          <NavMobileMenuLi>
            <NavMobileMenuIconDiv>
              ...
              </NavMobileMenuIconSvg>
              <NavMobileMenuIconSvg className="icon-twitter rainbow" onClick={() => window.open('about:blank').location.href='https://twitter.com/WeatherGirlsNFT'} version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 64 64">
              ...
              <NavMobileMenuIconSvg className="icon-discord rainbow" onClick={() => window.open('about:blank').location.href='https://discord.com/invite/pczWPcS85h'} version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 64 64">
              ...
              <NavMobileMenuIconSvg className="icon-youtube rainbow" onClick={() => window.open('about:blank').location.href='https://www.youtube.com/channel/UCU7jA5XDiijAZgYIuOYonQw'} version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 64 64">
              ...
              <NavMobileMenuIconSvg className="icon-instagram rainbow" onClick={() => window.open('about:blank').location.href='https://www.instagram.com/weathergirlsnft'} version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 64 64">
                <g>
                  <defs>
              ...
              <NavMobileMenuIconSvg className="icon-medium rainbow" onClick={() => window.open('about:blank').location.href='https://medium.com/@KlayWeatherGirls'} version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 64 64">
